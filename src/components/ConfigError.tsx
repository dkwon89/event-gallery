...
export default function ConfigError() {
  return (
    <div className="min-h-screen bg-neutral-50 flex items-center justify-center p-4">
      <div className="bg-white shadow-sm rounded-2xl p-8 max-w-md mx-auto text-center">
        <div className="mb-6">
        ...
        <div className="bg-gray-50 rounded-lg p-4 mb-6 text-left">
          ...
          <div className="space-y-2 text-sm">
            <div>
              <code className="bg-gray-200 px-2 py-1 rounded">NEXT_PUBLIC_SUPABASE_URL</code>
              <p className="text-gray-600 mt-1">Your Supabase project URL</p>
            </div>
            <div>
              <code className="bg-gray-200 px-2 py-1 rounded">NEXT_PUBLIC_SUPABASE_ANON_KEY</code>
